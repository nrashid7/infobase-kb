 ...
 * 
 * Usage: node kb/validate_kb_v3.js [path-to-kb-v3.json]
 */
...
const v2ValidatorPath = path.join(__dirname, 'validate_kb_v2.js');
...
function main() {
  ...
  // Default path
  let kbFile = path.join(__dirname, 'bangladesh_government_services_kb_v3.json');
  ...
  if (!fs.existsSync(kbFile)) {
    ...
    console.error('Usage: node kb/validate_kb_v3.js [path-to-kb-v3.json]');
    process.exit(1);
  }
