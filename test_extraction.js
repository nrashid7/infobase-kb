...
const markdown = `![BGDMRP banner](http://www.passport.gov.bd/images/banner.jpg)
...
const html = '<!DOCTYPE html><html><body>HTML content...</body></html>';

const result = extractStructuredData(markdown, 'https://passport.gov.bd/', html);
...
console.log('Docs found:', result.stats.doc_links_found);
console.log('\nSteps:');
result.steps.forEach((step, i) => console.log(`  ${i+1}. ${step.text.substring(0, 100)}...`));
